...
const StartPage = () => {
  return (
    <>
      <div className='flex lg:mx-80  md:mx-52 xl:mx-96 flex-col bg-cover bg-center bg-[url(https://images.unsplash.com/photo-1567536303373-0eb3957ba696?q=80&w=1976&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D)] h-screen justify-between '>
