...
const UserRidding = () => {
    ...
    return (
        <div className='flex overflow-hidden flex-col bg-cover h-screen bg-center bg-[url(https://s.wsj.net/public/resources/images/BN-XR452_201802_M_20180228165525.gif)]  '>
