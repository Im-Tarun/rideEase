  ...
  return (
    <div className='bg-white p-4'>
      ...
      <div onClick={() => { 
        ...
        <h2 className='text-lg font-bold my-auto flex'> ₹{params.fare?.cost.motorcycle}  </h2>
      </div>
      ...
      <div onClick={() => { 
        ...
        <h2 className='text-lg font-bold  my-auto'>₹{params.fare?.cost.auto} </h2>
      </div>
      ...
      <div onClick={() => { 
        ...
        <h2 className='text-lg font-bold my-auto'> ₹{params.fare?.cost.car} </h2>
      </div>
